...
$email_envio = 'contato@bikcraft.danieloliveira.info'; // E-mail receptor
$email_pass = 'QS!ArfBa&7HW'; // Senha do e-mail

$site_name = 'Bikcraft'; // Nome do Site
$site_url = 'bikcraft.danieloliveira.info'; // URL do Site

$host_smtp = 'smtp.weblink.com.br'; // HOST SMTP Ex: smtp.domain.com.br
