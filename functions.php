...
// Função para registrar o JS
function bikcraft_scritps() {
	...
	// Coloca o Modernizr no site.
	wp_enqueue_script('modernizr');

	// Coloca os scripts no site, não é necessário informar um a um, pois o main script já traz suas dependências.
	wp_enqueue_script('main-script');
}

add_action( 'wp_enqueue_scripts', 'bikcraft_scritps' );

// Função para registrar os CSS
